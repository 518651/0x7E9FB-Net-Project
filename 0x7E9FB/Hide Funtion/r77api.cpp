...
PR77_CONFIG LoadR77Config()
{
	...
	// Load configuration from HKEY_LOCAL_MACHINE\SOFTWARE\$WaotoCryconfig
	HKEY key;
...
{
	// Delete subkeys in HKEY_LOCAL_MACHINE\SOFTWARE\$WaotoCryconfig
	HKEY key;
	...
	// Delete HKEY_LOCAL_MACHINE\SOFTWARE\$WaotoCryconfig
